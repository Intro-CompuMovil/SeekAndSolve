...
class RecompensasCarrera : AppCompatActivity() {
    ...
    private fun quemarDatos() {
        ...
        matrixCursor.addRow(arrayOf(1, R.drawable.capitan_cuack_cuack, "Capitán Cuack Cuack", "Bogotá", "20/02/2025"))
        matrixCursor.addRow(arrayOf(2, R.drawable.denario_del_rey, "Denario del Rey", "Mosquera", "27/02/2025"))
        matrixCursor.addRow(arrayOf(3, R.drawable.roca_lunar, "Roca Lunar(Especial 2024)", "B/bermeja", "16/04/2025"))
        matrixCursor.addRow(arrayOf(4, R.drawable.mascara_sospechosa, "Mascara Sospechosa", "San vicente", "10/05/2025"))
